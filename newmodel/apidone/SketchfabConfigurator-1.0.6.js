var SketchfabConfigurator = function(e) {
    ...
    i.prototype = {
        template: '\n    <label for="{{id}}">{{option.name}}</label>\n    <div class="option__control">\n        <input type="checkbox" data-option="{{index}}" class="{{class}}" id="{{id}}" {{#value}}checked{{/value}}>\n    </div>\n    ',
        _generateId: function() {
            return "control_" + Math.floor(1e4 * Math.random())
        },
        render: function() {
            if (!this.el) {
            	//console.log(slug(this.model.options[this.index].name));
                ...
                var e = this.model.getOptionValue(this.index),
                    t = o.default.render(this.template, {
                        ...
                        class: slug(this.model.options[this.index].name),
                        value: e
                    });
                this.el.innerHTML = t
            }
    ...
    function u(e, t) {
        ...
        var x = document.getElementsByClassName("extinguisher-front-and-rear").checked;
  document.getElementById("demo").innerHTML = x;
  console.log("here is checkbox value"+ x);
    }
    u.prototype = {
        initialize: function() {
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        applyOptionSelect: function(e, t) {
            console.log("testing here"+this.options[e]);
            var r = this.options[e];
...
var lfckv = document.getElementsByClassName("extinguisher-front-and-rear").checked;
console.log(lfckv);
